#!/usr/bin/env bash
spark-submit \
--name "initial result sample 400M data" \
...
hdfs://ec2-18-205-44-23.compute-1.amazonaws.com:9000/sample400MJoinCountSentenceToHbase \
hdfs://ec2-18-205-44-23.compute-1.amazonaws.com:9000/sample400MSentenceScore/
