    ...
    return new RecordWriter<ImmutableBytesWritable, V>() {
      ...
      public void write(ImmutableBytesWritable row, V cell) throws IOException {
        ...
        if(row == null && kv == null) {
          ...
          WriterLength wl = (WriterLength)this.writers.get(family);
          if(wl == null) {
      ...
      private WriterLength getNewWriter(byte[] family, Configuration confx, InetSocketAddress[] favoredNodes) throws IOException {
      ...
      public void close(TaskAttemptContext c) throws IOException, InterruptedException {
        ...
        while(i$.hasNext()) {
          WriterLength wl = (WriterLength)i$.next();
          this.close(wl.writer);
        }
